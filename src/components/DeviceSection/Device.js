      ...
      <svg width="298" height="602">
       <defs>
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <rect width="5" height="24" x="0.5" y="76.5" stroke={secondaryColor} rx="2.5"/>
          <use fill={primaryColor} xlinkHref="#b"/>
          <rect width="5" height="43" x="0.5" y="129.5" stroke={secondaryColor} rx="2.5"/>
          <use fill={primaryColor} xlinkHref="#c"/>
          <rect width="5" height="43" x="0.5" y="184.5" stroke={secondaryColor} rx="2.5"/>
          <use fill={primaryColor} xlinkHref="#d"/>
          <rect width="5" height="43" x="292.5" y="129.5" stroke={secondaryColor} rx="2.5"/>
          <use fill={primaryColor} xlinkHref="#e"/>
          <rect width="291" height="601" x="3.5" y="0.5" stroke={secondaryColor} rx="40"/>
          <use fill={tertiaryColor} xlinkHref="#f"/>
          <rect width="44" height="44" x="127.5" y="540.5" stroke={secondaryColor} rx="22"/>
          ...
          <rect width="46" height="5" x="126.5" y="35.5" stroke={tertiaryColor} rx="2.5"/>
          <foreignObject width="260" height="462" x="19" y="57">
          <div className="Device" style={{height: '462px'}}>
            <img className="Device-img" src={image} />
          </div>
        </foreignObject>
          <rect width="262" height="464" x="18" y="56" stroke={secondaryColor} strokeWidth="2" rx="3"/>
        </g>
     </svg>
    )
  }
